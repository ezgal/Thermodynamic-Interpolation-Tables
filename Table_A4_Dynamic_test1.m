...
function [Output1]= Table_A4_Dynamic_test1(Input1,Input1_type,Input2,Input2_type,Output1_type)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% F = scatteredInterpolant(x_raw,y_raw,k_raw);
% [xmin,xmax] = bounds(x_raw);
% [ymin,ymax] = bounds(y_raw);
% [xGrid,yGrid]=meshgrid(linspace(xmin,xmax,40),linspace(ymin,ymax,40));
% zGrid = F(xGrid,yGrid);
% Output2 = F(Input1,Input2);
